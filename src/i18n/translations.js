export const translations = {
    en: {
        ...
        'vehicles.none': 'No vehicles registered yet.',
        'vehicles.name': 'Name',
        'vehicles.namePlaceholder': 'e.g. Toyota Hilux SRX',
        'vehicles.nickname': 'Nickname',
        'vehicles.nicknamePlaceholder': 'e.g. Beast',
        'vehicles.year': 'Year',
        'vehicles.description': 'Description',
        'vehicles.descriptionPlaceholder': 'Modifications, tires, story...',
        'vehicles.uploadPhoto': 'Upload Photo',
        'vehicles.save': 'Save',
        'vehicles.confirmDelete': 'Are you sure you want to remove this vehicle?',
        ...
        'admin.rangeReport': 'Custom Period Report',
        'admin.rangeReportDesc': 'Generate financial reports for any date range.',
        ...
        'admin.annualDues': 'Dues',
        'admin.annualDuesDesc': 'Yearly payment grid, per-member report and clearance certificate.',
        ...
        'annual.title': 'Dues',
        'annual.year': 'Year',
        'annual.viewMember': 'View',
        'annual.allMembers': 'All members',
        'annual.monthsPaid': 'Months paid',
        'annual.monthsPaidLower': 'months paid',
        'annual.compliance': 'Compliance',
        'annual.gridTitle': 'Payment grid for',
        'annual.total': 'Total',
        'annual.notApplicable': 'N/A',
        'annual.notDueYet': 'Not due yet',
        'annual.issueCertificate': 'Issue Clearance Certificate',
        'annual.certificateTitle': 'Annual Clearance Certificate',
        'annual.certificateBody': 'We hereby certify that {name} is in good standing with their membership dues for {months} month(s) owed during {year}, having paid a total of {amount}, according to the club\'s financial records.',
        'annual.issuedOn': 'Issued on',
        ...
        'report.contributionsCollected': 'Contributions Collected',
        'report.monthlyBreakdown': 'Monthly Breakdown',
        'report.memberBreakdown': 'Member Breakdown',
        'report.transactionsInPeriod': 'Transactions in Period',
        'report.paymentsCount': 'Payments',
        'report.totalCollected': 'Total Collected',
        'report.noData': 'No data for the selected period.',
        ...
        'member.markExempt': 'Mark as dues-exempt',
        'member.removeExempt': 'Remove dues exemption',
        'role.admin': 'Admin',
        'role.member': 'Member',
    ...
    pt: {
        ...
        'vehicles.none': 'Nenhum veículo cadastrado ainda.',
        'vehicles.name': 'Nome',
        'vehicles.namePlaceholder': 'ex: Toyota Hilux SRX',
        'vehicles.nickname': 'Apelido',
        'vehicles.nicknamePlaceholder': 'ex: Fera',
        'vehicles.year': 'Ano',
        'vehicles.description': 'Descrição',
        'vehicles.descriptionPlaceholder': 'Modificações, pneus, história...',
        'vehicles.uploadPhoto': 'Enviar Foto',
        'vehicles.save': 'Salvar',
        'vehicles.confirmDelete': 'Tem certeza que deseja remover este veículo?',
        ...
        'events.coverImage': 'Imagem de Capa',
        ...
        'admin.rangeReport': 'Relatório por Período',
        'admin.rangeReportDesc': 'Gere relatórios financeiros para qualquer período de datas.',
        ...
        'admin.annualDues': 'Mensalidades',
        'admin.annualDuesDesc': 'Grade de pagamentos do ano, relatório por membro e declaração de quitação.',
        ...
        'annual.title': 'Mensalidades',
        'annual.year': 'Ano',
        'annual.viewMember': 'Visualizar',
        'annual.allMembers': 'Todos os membros',
        'annual.monthsPaid': 'Meses pagos',
        'annual.monthsPaidLower': 'meses pagos',
        'annual.compliance': 'Adimplência',
        'annual.gridTitle': 'Grade de pagamentos de',
        'annual.total': 'Total',
        'annual.notApplicable': 'N/A',
        'annual.notDueYet': 'Ainda não vence',
        'annual.issueCertificate': 'Emitir Declaração de Quitação',
        'annual.certificateTitle': 'Declaração de Quitação Anual',
        'annual.certificateBody': 'Declaramos, para os devidos fins, que {name} encontra-se em situação de adimplência plena com suas mensalidades, tendo quitado a totalidade dos {months} mês(es) devido(s) durante o ano de {year}, no valor total de {amount}, conforme registros financeiros do clube.',
        'annual.issuedOn': 'Emitido em',
        ...
        // Relatórios
        'report.title': 'Relatório por Período',
        'report.print': 'Imprimir / Exportar PDF',
        'report.startDate': 'Data Início',
        'report.endDate': 'Data Fim',
        'report.quickRanges': 'Períodos Rápidos',
        'report.thisMonth': 'Este Mês',
        'report.last3Months': 'Últimos 3 Meses',
        'report.last6Months': 'Últimos 6 Meses',
        'report.thisYear': 'Este Ano',
        'report.period': 'Período',
        'report.totalIncome': 'Total de Receitas',
        'report.totalExpenses': 'Total de Despesas',
        'report.netBalance': 'Saldo Líquido',
        'report.contributionsCollected': 'Mensalidades Arrecadadas',
        'report.monthlyBreakdown': 'Detalhamento Mensal',
        'report.memberBreakdown': 'Detalhamento por Membro',
        'report.transactionsInPeriod': 'Lançamentos no Período',
        'report.paymentsCount': 'Pagamentos',
        'report.totalCollected': 'Total Arrecadado',
        'report.noData': 'Nenhum dado para o período selecionado.',
        ...
        'member.markExempt': 'Marcar como isento',
        'member.removeExempt': 'Remover isenção',
    ...
    es: {
        ...
        'vehicles.none': 'Aún no hay vehículos registrados.',
        'vehicles.name': 'Nombre',
        'vehicles.namePlaceholder': 'ej: Toyota Hilux SRX',
        'vehicles.nickname': 'Apodo',
        'vehicles.nicknamePlaceholder': 'ej: Bestia',
        'vehicles.year': 'Año',
        'vehicles.description': 'Descripción',
        'vehicles.descriptionPlaceholder': 'Modificaciones, neumáticos, historia...',
        'vehicles.uploadPhoto': 'Subir Foto',
        'vehicles.save': 'Guardar',
        'vehicles.confirmDelete': '¿Estás seguro de que deseas eliminar este vehículo?',
        ...
        'events.coverImage': 'Imagen de Portada',
        ...
        'admin.rangeReport': 'Informe por Período',
        'admin.rangeReportDesc': 'Genere informes financieros para cualquier rango de fechas.',
        ...
        'admin.annualDues': 'Cuotas',
        'admin.annualDuesDesc': 'Cuadrícula anual de pagos, informe por miembro y certificado de al día.',
        ...
        'annual.title': 'Cuotas',
        'annual.year': 'Año',
        'annual.viewMember': 'Ver',
        'annual.allMembers': 'Todos los miembros',
        'annual.monthsPaid': 'Meses pagados',
        'annual.monthsPaidLower': 'meses pagados',
        'annual.compliance': 'Cumplimiento',
        'annual.gridTitle': 'Cuadrícula de pagos de',
        'annual.total': 'Total',
        'annual.notApplicable': 'N/A',
        'annual.notDueYet': 'Aún no vence',
        'annual.issueCertificate': 'Emitir Certificado de Al Día',
        'annual.certificateTitle': 'Certificado Anual de Estar al Día',
        'annual.certificateBody': 'Certificamos que {name} se encuentra al día con sus cuotas, habiendo pagado la totalidad de los {months} mes(es) adeudados durante el año {year}, por un total de {amount}, según los registros financieros del club.',
        'annual.issuedOn': 'Emitido el',
        ...
        // Informes
        'report.title': 'Informe por Período',
        'report.print': 'Imprimir / Exportar PDF',
        'report.startDate': 'Fecha Inicio',
        'report.endDate': 'Fecha Fin',
        'report.quickRanges': 'Rangos Rápidos',
        ...
        'report.contributionsCollected': 'Cuotas Recaudadas',
        'report.monthlyBreakdown': 'Desglose Mensual',
        'report.memberBreakdown': 'Desglose por Miembro',
        'report.transactionsInPeriod': 'Transacciones en el Período',
        'report.paymentsCount': 'Pagos',
        'report.totalCollected': 'Total Recaudado',
        'report.noData': 'No hay datos para el período seleccionado.',
        ...
        'member.markExempt': 'Marcar como exento',
        'member.removeExempt': 'Quitar exención',
        'role.admin': 'Administrador',
        'role.member': 'Miembro',
